package aula2708;
public class FilaVectorAtividade<T> {
    private T[] fila;
    private int frente;
    ...
    public FilaVectorAtividade(int capacidade) {
    ...
    public static void main(String[] args) {
        FilaVectorAtividade<Integer> fila = new FilaVectorAtividade<>(5);
        ...
        FilaVectorAtividade<Pessoa> filaPessoas = new FilaVectorAtividade<>(5);
